...
SELECT * FROM students; /* 2. Вывести всех студентов в таблице */
...
FROM students;  /* 7. Вывести id, имя, email и дату создания пользователей */
...
SELECT * FROM students 
WHERE name like '%Anna%'; /* где имя Анна - латиницей */
...
SELECT * FROM students 
WHERE name LIKE '%a%'; /* 12. Вывести пользователей где в имени в есть буква а */
